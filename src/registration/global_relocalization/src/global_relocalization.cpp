...
GlobalRelocalization::GlobalRelocalization() : Node("global_relocalization")
{
  ...
  num_threads_ = 4;
  num_neighbors_ = 20;
  // TODO: make this a configurable parameter instead of a hardcoded path
  ...
  if (prior_pcd_file_.empty()) {
    prior_pcd_file_ = "/home/ros/rosws/3d_nav_ws/src/Lidar_nav2_ws/src/planner/nav2_planner_bringup/pcd/nav_test_4_27.pcd";
  }
