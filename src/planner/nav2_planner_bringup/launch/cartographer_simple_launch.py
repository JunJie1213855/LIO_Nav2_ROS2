...
建图用法:
  ros2 launch nav2_planner_bringup cartographer_simple_launch.py

定位用法:
  ros2 launch nav2_planner_bringup cartographer_simple_launch.py \
      pure_localization:=true load_pbstream:=/ws/src/planner/nav2_planner_bringup/map/map.pbstream
"""
