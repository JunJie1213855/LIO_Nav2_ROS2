...
docker exec lio_nav2 bash -c "
  ...
  ros2 service call /write_state cartographer_ros_msgs/srv/WriteState \
    '{filename: \"/ws/src/planner/nav2_planner_bringup/map/map.pbstream\", include_unfinished_submaps: true}'"
...
- 确认 `.pbstream` 路径正确：`docker exec lio_nav2 ls -la /ws/src/planner/nav2_planner_bringup/map/map.pbstream`
