...
echo "      \"{filename: \\\"/ws/src/planner/nav2_planner/map/airy_map.pbstream\\\", include_unfinished_submaps: true}\" && \\"
...
echo "      -pbstream_filename /ws/src/planner/nav2_planner/map/airy_map.pbstream \\"
echo "      -map_filestem /ws/src/planner/nav2_planner/map/airy_map'"
