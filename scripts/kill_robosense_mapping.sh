#!/usr/bin/env bash
# ============================================================
# 关闭 robosense_mapping_real.sh 启动的所有终端和节点
# 用法: ./scripts/kill_robosense_mapping.sh
# ============================================================

echo "=== 关闭 RoboSense Airy 实机建图所有节点 ==="

# ── 方式1: 关闭 gnome-terminal 窗口（按标题匹配） ──
WINDOW_TITLES=(
    "FAST-LIO 里程计"
...
# ── 方式3: 按 launch 文件名匹配，清理残留 ros2 launch ──
LAUNCH_PATTERNS=(
