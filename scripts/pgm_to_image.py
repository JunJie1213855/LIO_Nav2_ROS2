...
示例:
  # 转成 png（默认）
  python3 pgm_to_image.py src/me_nav2_bringup/map/test_map__2.pgm

  # 指定输出路径和格式
  python3 pgm_to_image.py src/me_nav2_bringup/map/test_map__2.pgm -o /tmp/map.jpg --format jpg
"""
